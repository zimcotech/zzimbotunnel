      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-[2.5rem] p-8 md:p-14 shadow-2xl shadow-brand-green/5 border border-brand-yellow/10">
          ...
          <div className="prose prose-green max-w-none text-gray-600">
            ...
            <h2 className="text-2xl font-black text-gray-900 mt-10 mb-5 flex items-center gap-3 border-l-4 border-brand-green pl-4 bg-brand-green-light/20 py-4 rounded-r-xl">
              <span className="w-8 h-8 rounded-lg bg-brand-green text-white flex items-center justify-center text-sm">4</span>
              No Logging Policy
            </h2>
            <p className="mb-6 leading-relaxed font-bold text-gray-900">We strictly adhere to a no-logging policy for your internet traffic. We do not monitor, record, or store your browsing history, DNS queries, or data content accessed through our tunneling servers.</p>
            
            <h2 className="text-2xl font-black text-gray-900 mt-10 mb-5 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-brand-yellow-light text-brand-yellow-dark flex items-center justify-center text-sm">5</span>
              Contact Us
            </h2>
